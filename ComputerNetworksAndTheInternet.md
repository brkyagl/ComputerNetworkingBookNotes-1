...
Daha önce gördüğümüz gibi, end systems (PC'ler, smartphone'lar, Web server'ları, mail server'ları vb.) bir **access ISP** aracılığıyla Internet'e bağlanır. 
Access ISP, DSL, cable, FTTH, Wi-Fi ve hücresel dahil olmak üzere bir dizi access teknolojisi kullanarak wired veya wireless connectivity sağlayabilir.
Access ISP'nin bir telco veya cable şirketi olması gerekmez; bunun yerine örneğin bir üniversite (öğrencilere, personeline ve akademisyenlerine Internet access sağlayan) veya bir şirket (çalışanlarına access sağlayan) olabilir. 
Ama end users ve content providers'ı bir access ISP'ye bağlamak, Internet'i oluşturan milyarlarca end system'i birbirine bağlama bulmacasının sadece küçük bir parçasıdır. 
Bu bulmacayı tamamlamak için, access ISP'lerin kendilerinin de birbirine bağlanması gerekir. Bu, bir **network of networks** oluşturularak yapılır — bu ifadeyi anlamak, Internet'i anlamanın anahtarıdır.

Yıllar içinde, Internet'i oluşturan network of networks çok karmaşık bir yapıya evrimleşti. Bu evrimin çoğu, “performansla ilgili hususlar” bölümünden ziyade **economics** ve **national policy** tarafından yönlendirilmiştir. 
Günümüzün Internet network structure'ını anlamak için, karmaşık Internet'e giderek daha iyi bir yaklaşım olan bir dizi network structure'ı artımsal olarak inşa edelim. 
Hatırlayın ki, temel amaç tüm end systems'lerin birbirine packet gönderebilmesi için access ISP'leri birbirine bağlamaktır. 
Naif bir yaklaşım, her access ISP'nin diğer her access ISP ile **doğrudan** bağlanması olurdu. Böyle bir mesh design elbette çok maliyetli olurdu, çünkü her access ISP'nin dünya genelindeki yüz binlerce diğer access ISP'nin her birine ayrı bir communication link'i olmasını gerektirirdi.

İlk network structure'ımız, **Network Structure 1**, tüm access ISP'lerini tek bir **global transit ISP** ile birbirine bağlar. 
Hayali global transit ISP'miz, sadece dünya çapında span eden router ve communication links'ten oluşan bir network değil, aynı zamanda yüz binlerce access ISP'nin her birinin yakınında en az bir router'a sahip olan bir network'tür. 
Elbette, global ISP'nin böyle kapsamlı bir network inşa etmesi çok maliyetli olurdu. Karlı olması için, access ISP'lerin her birinden connectivity için doğal olarak ücret alması gerekir; fiyatlandırma, access ISP'nin global ISP ile exchange ettiği traffic miktarını (doğrudan orantılı olmasa bile) yansıtır. Access ISP global transit ISP'ye ödeme yaptığı için, access ISP'ye **customer** (müşteri) ve global transit ISP'ye **provider** (sağlayıcı) denir.

Eğer bir şirket karlı bir global transit ISP inşa edip işletirse, o zaman diğer şirketlerin de kendi global transit ISP'lerini inşa edip orijinal global transit ISP ile rekabet etmesi doğaldır. 
Bu, **Network Structure 2**'ye yol açar; bu structure, yüz binlerce access ISP ve **multiple global transit ISP**'den oluşur. 
Access ISP'ler Network Structure 2'yi Network Structure 1'e tercih ederler, çünkü artık rekabetçi global transit provider'lar arasında fiyatlandırma ve servislerine göre seçim yapabilirler. 
Ancak, global transit ISP'lerin kendilerinin de birbirine bağlanması gerekir: Aksi takdirde, bir global transit provider'a bağlı access ISP'ler, diğer global transit provider'lara bağlı access ISP'lerle iletişim kuramaz.

Network Structure 2, az önce tanımlanan, üst katmanda global transit provider'ların ve alt katmanda access ISP'lerin bulunduğu iki katmanlı bir hiyerarşidir. 
Bu, global transit ISP'lerin sadece her access ISP'ye yakın olabileceğini değil, bunu ekonomik olarak yapmak istediğini de varsayar. 
Gerçekte, bazı ISP'ler etkileyici global kapsama sahip olsa ve birçok access ISP ile doğrudan bağlansa da, dünyadaki her şehirde mevcudiyet'i olan hiçbir ISP yoktur. 
Bunun yerine, herhangi bir bölgede, o bölgedeki access ISP'lerin bağlandığı bir **regional ISP** olabilir. Her regional ISP daha sonra **tier-1 ISP**'lere bağlanır. 
Tier-1 ISP'ler hayali global transit ISP'lerimize benzer; ama gerçekte var olan tier-1 ISP'ler dünyadaki her şehirde mevcudiyete sahip değildir. 
Yaklaşık **bir düzine tier-1 ISP** vardır; bunlar arasında Level 3 Communications, AT&T, Sprint ve NTT bulunur. 
İlginç bir şekilde, resmi olarak tier-1 statüsünü onaylayan bir grup yoktur; söylendiği gibi — eğer bir grubun üyesi olup olmadığını sormak zorundaysanız, muhtemelen değilsinizdir.

Bu network of networks'e dönersek, sadece rekabetçi tier-1 ISP'ler yoktur, bir bölgede rekabetçi regional ISP'ler de olabilir. 
Böyle bir hiyerarşide, her access ISP bağlandığı regional ISP'ye ödeme yapar, ve her regional ISP bağlandığı tier-1 ISP'ye ödeme yapar. (Bir access ISP doğrudan bir tier-1 ISP'ye de bağlanabilir; bu durumda tier-1 ISP'ye ödeme yapar.) 
Böylece, hiyerarşinin her seviyesinde customer-provider ilişkisi vardır. Tier-1 ISP'ler hiyerarşinin tepesinde oldukları için kimseye ödeme yapmazlar. 
İşleri daha da karmaşıklaştırmak için, bazı bölgelerde daha büyük bir regional ISP (muhtemelen tüm bir ülkeyi kapsayan) olabilir; bu büyük regional ISP, o bölgedeki daha küçük regional ISP'lere bağlanır; daha büyük regional ISP daha sonra bir tier-1 ISP'ye bağlanır. Örneğin Çin'de, her şehirde access ISP'ler vardır; bunlar provincial(il düzeyinde) ISP'lere bağlanır, bunlar national ISP'lere bağlanır, bunlar sonunda tier-1 ISP'lere bağlanır [Tian 2012]. Bu multi-tier hiyerarşiye, ki bu günümüz Internet'inin hâlâ sadece kaba bir yaklaşımıdır, **Network Structure 3** diyoruz.

Günümüze daha yakın bir network inşa etmek için, hiyerarşik Network Structure 3'e **points of presence (PoPs)**, **multi-homing**, **peering** ve **Internet exchange points (IXP)** eklemeliyiz. 
PoP'lar hiyerarşinin tüm seviyelerinde bulunur, bottom (access ISP) seviyesi hariç. Bir **PoP**, provider'ın network'ünde customer ISP'lerin bağlanabileceği aynı lokasyondaki bir veya daha fazla router grubudur. 
Bir customer network'un bir provider'ın PoP'una bağlanması için, üçüncü taraf bir telecommunications provider'dan high-speed link kiralayarak kendi router'larından birini PoP'taki bir router'a doğrudan bağlayabilir. 
Herhangi bir ISP (tier-1 ISP'ler hariç) **multi-home** olmayı seçebilir; yani iki veya daha fazla provider ISP'ye bağlanabilir. 
Örneğin bir access ISP iki regional ISP ile multi-home olabilir, veya iki regional ISP ile ve ayrıca bir tier-1 ISP ile multi-home olabilir. 
Benzer şekilde, bir regional ISP birden fazla tier-1 ISP ile multi-home olabilir. Bir ISP multi-home olduğunda, provider'larından biri hata yaşasa bile Internet'e packet göndermeye ve almaya devam edebilir.

Az önce öğrendiğimiz gibi, customer ISP'ler global Internet interconnectivity elde etmek için provider ISP'lerine ödeme yapar. 
Bir customer ISP'nin provider ISP'ye ödediği miktar, provider ile exchange ettiği traffic miktarını yansıtır. 
Bu maliyetleri azaltmak için, aynı hiyerarşi seviyesindeki bir çift yakın ISP **peer** yapabilir; yani network'lerini doğrudan birbirine bağlayabilir, böylece aralarındaki tüm traffic doğrudan connection üzerinden geçer, upstream aracıları üzerinden değil. İki ISP peer yaptığında, tipik olarak **settlement-free**'dir; yani hiçbir ISP diğerine ödeme yapmaz. 
Daha önce de belirtildiği gibi, tier-1 ISP'ler de birbirleriyle settlement-free olarak peer yapar. Peering ve customer-provider ilişkileri hakkında okunabilir bir tartışma için [Vander Berg 2008 - ben şöyle bi' şey buldum https://cseweb.ucsd.edu/classes/wi01/cse222/papers/norton-isp-draft00.pdf]'e bakın.

Aynı doğrultuda, üçüncü taraf bir şirket bir **Internet Exchange Point (IXP)** oluşturabilir; bu, birden fazla ISP'nin bir araya geldiği bir meeting point'tir. 
Bir IXP tipik olarak kendi switch'leri olan bağımsız bir binadır [Ager 2012 - şunu buldum https://dl.acm.org/doi/epdf/10.1145/2377677.2377714]. Günümüzde Internet'te **600'den fazla IXP** vardır [PeeringDB 2025 - https://www.peeringdb.com/advanced_search#net]. Access ISP'ler, regional ISP'ler, tier-1 ISP'ler, PoP'lar, multi-homing, peering ve IXP'lerden oluşan bu ekosisteme **Network Structure 4** diyoruz.

Şimdi son olarak **Network Structure 5**'e ulaşıyoruz; bu, günümüz Internet'ini tanımlar. Network Structure 4 üzerine **content-provider network**'leri ekleyerek inşa edilir. Google şu anda content-provider network'lerinin önde gelen örneklerinden biridir. Google'ın Kuzey Amerika, Avrupa, Asya ve Güney Amerika'da dağılmış **20'den fazla büyük data center'ı** vardır [Google datacenters 2024 - https://datacenters.google/locations/]; her data center onlarca veya yüzlerce server'a sahiptir. Ek olarak Google'ın daha küçük data center'ları vardır; bunların her birinde birkaç yüz server bulunur; bu daha küçük data center'lar genellikle IXP'ler içinde yer alır. 
Google data center'larının tümü, Google'ın özel TCP/IP network'ü üzerinden birbirine bağlıdır; bu network tüm dünyayı kapsar ama yine de public Internet'ten ayrıdır. 
Önemlisi, Google'ın özel network'ü sadece Google server'larından/to Google server'larına traffic taşır, 2026 itibarıyla Google'ın dünya çapındaki cloud network'ünü gösterir [Google Cloud - https://cloud.google.com/about/locations#scale-globally burada haritalardan detaylı bakılabilir].

Google'ın özel network'ü, alt katman ISP'lerle **peering** (settlement-free) yaparak Internet'in üst katmanlarını "bypass" etmeye çalışır; bunu doğrudan onlarla bağlanarak veya IXP'lerde onlarla bağlanarak yapar [Labovitz 2010 - şuna bakılabilir https://dl.acm.org/doi/epdf/10.1145/1851182.1851194]. Ancak, birçok access ISP hâlâ sadece tier-1 network'ler üzerinden transit edilerek ulaşılabildiği için, Google network'ü aynı zamanda tier-1 ISP'lere de bağlanır ve onlarla exchange ettiği traffic için bu ISP'lere ödeme yapar. 
Kendi network'ünü oluşturarak, bir content provider sadece üst katman ISP'lere olan ödemelerini azaltmakla kalmaz, aynı zamanda servislerinin nihai olarak end users'a nasıl teslim edildiği üzerinde daha fazla kontrole sahip olur. 
2020 itibarıyla, Amazon, Google, IBM ve Microsoft gibi cloud provider'lar toplu olarak Internet'in **%76'sına** Tier-1 ISP'lerden geçmeden ulaşabilmektedir [Arnold 2020].
